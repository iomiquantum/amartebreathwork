...
const faqs = [
  ...
  {
    q: "¿Qué debo llevar?",
    a: "Ropa cómoda, apertura para vivir la experiencia y llegar unos minutos antes. Los detalles específicos se compartirán dentro del grupo antes de cada sesión.",
  },
  {
    q: "¿Dónde serán las sesiones?",
    a: "La ubicación se anunciará dentro del grupo de WhatsApp junto con la fecha, horario y disponibilidad de cupos.",
  },
  {
  ...
  },
  {
    ...
    a: "No. El grupo es gratuito y sirve para recibir información de las próximas experiencias.",
  },
];
